    ...
    <footer className="bg-gradient-to-br from-[#ECF6FF] via-white to-[#ECF6FF] border-t border-[#0077B6]/20">
      <div className="container-custom px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="py-8 sm:py-12">
            ...
            >
              ...
              <div className="space-y-1 sm:space-y-2">
                <p className="text-[#555555] text-xs sm:text-sm">
                  <span className="text-brand-blue">Email:</span> sssbennani@gmail.com
                </p>
                <p className="text-[#555555] text-xs sm:text-sm">
                  <span className="text-brand-blue">Téléphone:</span> 0719-109122
                </p>
                <p className="text-[#555555] text-xs sm:text-sm">
                ...
                {[
                  ...
                  >
                    <button
                      ...
                      className="text-[#555555] hover:text-brand-blue transition-colors duration-300 text-left text-xs sm:text-sm"
                    >
                      {link.name}
                    </button>
                  </motion.li>
          ...
          {/* Social Links */}
          <motion.div
            className="border-t border-[#0077B6]/20 pt-6 sm:pt-8 mt-6 sm:mt-8"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="flex gap-3 sm:gap-4">
                {[
                  ...
                  { name: 'Email', icon: 'M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z', url: 'mailto:sssbennani@gmail.com' }
                ].map((social, index) => (
                  <motion.a
                    key={social.name}
                    href={social.url}
                    ...
                    className="w-10 h-10 sm:w-12 sm:h-12 bg-[#0077B6] rounded-full flex items-center justify-center text-white hover:bg-[#0099CC] transition-all duration-300 shadow-md hover:shadow-lg"
                    whileHover={{ 
                      scale: 1.1,
                      rotate: [0, 5, -5, 0]
                    }}
              ...
              {/* Copyright */}
              <motion.p
                className="text-[#666666] text-xs sm:text-sm font-medium"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
